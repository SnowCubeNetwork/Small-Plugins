...
class ChannelManager
{
    ...
    {
        $name = $this->normalize($name);
        $perm = new Permission("chatchannels.channel.$name", "Allow joining channel '$name'", ($default === true || $default === Permission::DEFAULT_TRUE) ? Permission::DEFAULT_TRUE : Permission::DEFAULT_FALSE);
